...
Adam Adamandy Kochański herbu Lubicz, dworzanin króla Jana Sobieskiego znajdzie przybliżenie
\begin{equation}
    \sqrt{\frac{40}{3} - 2 \sqrt{3}} \approx 3.14153\,33387
\end{equation}
w pracy \emph{Observationes Cyclometricae ad facilitandam Praxin accommodatae} (\emph{Obserwacje cyklometryczne przystosowane dla ułatwienia praktycznego użycia})
