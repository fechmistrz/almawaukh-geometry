...
\index[persons]{Kazarinoff, ???}
\index[persons]{Bankoff, ???}%
\index[persons]{Alsina, ???}%
...
Twierdzenie poda w formie ćwiczenia Coxeter \cite[s. 25]{coxeter_1967}, Audin z licznymi wskazówkami \cite[s. 102]{audin_2003}.
