...
Najstarszy zachowany dowód twierdzenia Talesa podaje Euklides (VI.2).
Piszą o nim Neugebauer, Bogdańska \cite[s. 48-56]{neugebauer_2018}; Audin \cite[s. 24, 173]{audin_2003}.

Po angielsku znane jest jako \emph{intercept theorem}, \emph{basic proportionality theorem} albo \emph{side splitter theorem}; natomiast nazwy \emph{Thales's theorem} używa się o~dziwo wobec innego wyniku, że kąt oparty na półokręgu jest prosty (!).
