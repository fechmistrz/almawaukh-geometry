% TODO: coaxial circles: Coxeter 85 coaxal
...
Użył jej, aby znaleźć okrąg przecinający cztery dane okręgi pod tym samym kątem; rozwiązać problem Apolloniusza; skonstruować okręgi Malfattiego (trzy okręgi, które są styczne do pozostałych dwóch oraz boków zadanego trójkąta).
% TODO: index, ref
...
\label{guzicki_6_11}%
    ...
    Wtedy mającychiejscem geometrycznym punktów $P$ mających równe potęgi względem obu okręgów:
	\begin{equation}
...
\begin{proposition}[środek potęgowy]
	...
	Wtedy albo środki tych okręgów są współliniowe (i trzy osie potęgowe każdej pary są równoległe), albo wszystkie trzy osie przecinają się w~jednym punkcie: \emph{środkiem potęgowym} okręgów.
\end{proposition}
