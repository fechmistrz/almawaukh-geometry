...
O twierdzeniu Ptolemeusza piszą Bogdańska, Neugebauer \cite[s. 62, 63]{neugebauer_2018}, Audin \cite[s. 108]{audin_2003}, Eves \cite[s. 132]{eves1_1972} (z prostym dowodym opartym na inwersjach) oraz ktoś w $\Delta_{24}^{8}$.
Waldemar Pompe w $\Delta_{95}^1$ przedstawi inwersyjny dowód. % https://www.deltami.edu.pl/1995/01/jeszcze-raz-o-nierownosci-ptolemeusza/
