...
\subsection{Trzy symetralne}
\input{triangle/points-excenter}

\subsection{Trzy dwusieczne}
\input{triangle/points-incenter}

\subsection{Trzy wysokości}
\input{triangle/points-orthocenter}

\subsection{Trzy środkowe}
\input{triangle/points-centroid}
